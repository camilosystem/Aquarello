...
\restrict MsnuaYRCkPgjT6Oisa1Ah2ack77WatmLjoCiZXqoMxe95PuEP0Fvua8SFqbwN5t
...
CREATE TABLE public.app_settings (
    ...
    price_per_kg integer DEFAULT 8000 NOT NULL,
    min_price integer DEFAULT 25000 NOT NULL,
    price_ironing integer DEFAULT 5000 NOT NULL,
    price_softener integer DEFAULT 2000 NOT NULL,
    price_bleach integer DEFAULT 1500 NOT NULL,
    price_degreaser integer DEFAULT 2500 NOT NULL,
    price_stain_treatment integer DEFAULT 4000 NOT NULL,
    price_delicate_care integer DEFAULT 2000 NOT NULL,
    price_special_folding integer DEFAULT 1000 NOT NULL,
    price_express integer DEFAULT 10000 NOT NULL,
    opening_time text DEFAULT '07:00'::text NOT NULL,
    closing_time text DEFAULT '20:00'::text NOT NULL,
    avg_wash_minutes integer DEFAULT 120 NOT NULL,
    notif_new_order boolean DEFAULT true NOT NULL,
    notif_low_stock boolean DEFAULT true NOT NULL,
    notif_order_ready boolean DEFAULT true NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_by uuid,
    price_separate_whites integer DEFAULT 3000 NOT NULL,
    price_separate_colors integer DEFAULT 3000 NOT NULL
);
...
CREATE TABLE public.inventory (
    ...
    cost_per_box numeric(12,2) DEFAULT 0 NOT NULL,
...
CREATE TABLE public.machines (
    ...
    CONSTRAINT machines_status_check CHECK ((status = ANY (ARRAY['disponible'::text, 'en_uso'::text, 'mantenimiento'::text]))),
    CONSTRAINT machines_type_check CHECK ((type = ANY (ARRAY['lavadora'::text, 'secadora'::text])))
);


--
-- Name: order_bags; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: order_preferences; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.order_preferences (
    ...
    scent text DEFAULT 'ninguno'::text,
    iron_clothes boolean DEFAULT false,
    fold_type text DEFAULT 'normal'::text,
    special_instructions text,
    created_at timestamp with time zone DEFAULT now(),
    separate_colors boolean DEFAULT false,
    stain_count integer DEFAULT 0,
    stain_treatment boolean DEFAULT false NOT NULL
);
...
CREATE TABLE public.orders (
    ...
    pickup_city text DEFAULT 'Bogota'::text,
    pickup_date date,
    ...
    reception_code character varying(6),
    walk_in_name text,
    walk_in_phone text,
    ...
    CONSTRAINT orders_payment_status_check CHECK ((payment_status = ANY (ARRAY['pendiente'::text, 'pagado'::text, 'reembolsado'::text]))),
    CONSTRAINT orders_status_check CHECK ((status = ANY (ARRAY['pendiente'::text, 'recogido'::text, 'en_deposito'::text, 'en_transito'::text, 'en_transito_lavado'::text, 'en_lavado'::text, 'en_secado'::text, 'en_alistamiento'::text, 'listo'::text, 'en_transito_entrega'::text, 'en_ruta_entrega'::text, 'entregado'::text, 'cancelado'::text])))
);
...
CREATE TABLE public.payments (
    ...
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT payments_payment_method_check CHECK ((payment_method = ANY (ARRAY['efectivo'::text, 'nequi'::text, 'brevo'::text, 'payu'::text, 'tarjeta'::text, 'transferencia'::text, 'daviplata'::text]))),
    CONSTRAINT payments_status_check CHECK ((status = ANY (ARRAY['pendiente'::text, 'completado'::text, 'fallido'::text, 'reembolsado'::text])))
);
...
CREATE TABLE public.profiles (
    ...
    phone text,
    address text,
    city text DEFAULT 'Bogota'::text,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    operator_notes text,
    email text,
    is_active boolean DEFAULT true,
    CONSTRAINT profiles_role_check CHECK ((role = ANY (ARRAY['cliente'::text, 'domiciliario'::text, 'operador'::text, 'conductor'::text, 'admin'::text])))
);


--
-- Name: washing_process; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.washing_process (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    order_id uuid NOT NULL,
    operator_id uuid,
    ...
    washing_started timestamp with time zone,
    washing_ended timestamp with time zone,
    drying_started timestamp with time zone,
    drying_ended timestamp with time zone,
    completed_at timestamp with time zone,
    notes text,
    alistamiento_completed boolean DEFAULT false NOT NULL,
    lavado_completed boolean DEFAULT false NOT NULL,
    secado_completed boolean DEFAULT false NOT NULL,
    planchado_completed boolean DEFAULT false NOT NULL,
    doblado_completed boolean DEFAULT false NOT NULL,
    updated_at timestamp with time zone DEFAULT now(),
    created_at timestamp with time zone DEFAULT now()
);
...
--
-- Name: order_bags order_bags_bag_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_bags
    ADD CONSTRAINT order_bags_bag_code_key UNIQUE (bag_code);


--
-- Name: order_bags order_bags_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_bags
    ADD CONSTRAINT order_bags_pkey PRIMARY KEY (id);
...
--
-- Name: order_preferences order_preferences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_preferences
    ADD CONSTRAINT order_preferences_pkey PRIMARY KEY (id);
...
--
-- Name: orders orders_qr_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_qr_code_key UNIQUE (qr_code);
...
--
-- Name: washing_process washing_process_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.washing_process
    ADD CONSTRAINT washing_process_pkey PRIMARY KEY (id);
...
--
-- Name: machines machines_current_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.machines
    ADD CONSTRAINT machines_current_order_id_fkey FOREIGN KEY (current_order_id) REFERENCES public.orders(id);


--
-- Name: order_bags order_bags_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_bags
    ADD CONSTRAINT order_bags_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;
...
--
-- Name: order_preferences order_preferences_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_preferences
    ADD CONSTRAINT order_preferences_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;


--
-- Name: orders orders_assigned_delivery_person_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_assigned_delivery_person_fkey FOREIGN KEY (assigned_delivery_person) REFERENCES auth.users(id);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_assigned_driver_fkey FOREIGN KEY (assigned_driver) REFERENCES auth.users(id);


--
-- Name: orders orders_assigned_operator_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_assigned_operator_fkey FOREIGN KEY (assigned_operator) REFERENCES auth.users(id);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_delivery_person_id_fkey FOREIGN KEY (delivery_person_id) REFERENCES public.profiles(id);
...
--
-- Name: orders orders_operator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_operator_id_fkey FOREIGN KEY (operator_id) REFERENCES auth.users(id) ON DELETE SET NULL;
...
--
-- Name: washing_process washing_process_operator_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.washing_process
    ADD CONSTRAINT washing_process_operator_id_fkey FOREIGN KEY (operator_id) REFERENCES public.profiles(id) ON DELETE SET NULL;


--
-- Name: washing_process washing_process_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.washing_process
    ADD CONSTRAINT washing_process_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;
...
--
-- Name: order_history Permitir insertar historial; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Permitir insertar historial" ON public.order_history FOR INSERT TO authenticated WITH CHECK (true);


--
-- Name: orders Permitir lectura de ordenes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Permitir lectura de ordenes" ON public.orders FOR SELECT TO authenticated USING (true);


--
-- Name: profiles Permitir lectura de perfiles; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: order_bags Permitir todo en bolsas; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Permitir todo en bolsas" ON public.order_bags TO authenticated USING (true);


--
-- Name: profiles Permitir update de perfiles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Permitir update de perfiles" ON public.profiles FOR UPDATE TO authenticated USING (true);


--
-- Name: orders Permitir update en ordenes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Permitir update en ordenes" ON public.orders FOR UPDATE TO authenticated USING (true);


--
-- Name: order_history Staff can insert history; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Staff can insert history" ON public.order_history FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['domiciliario'::text, 'operador'::text, 'conductor'::text, 'admin'::text]))))));
...
--
-- Name: order_history Staff can view all history; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Staff can view all history" ON public.order_history FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['domiciliario'::text, 'operador'::text, 'conductor'::text, 'admin'::text]))))));
...
--
-- Name: order_preferences Staff can view all preferences; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Staff can view all preferences" ON public.order_preferences FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['domiciliario'::text, 'operador'::text, 'conductor'::text, 'admin'::text]))))));


--
-- Name: order_history Users can insert own order history; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own order history" ON public.order_history FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_history.order_id) AND (orders.user_id = auth.uid())))));


--
-- Name: order_preferences Users can insert own order preferences; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own order preferences" ON public.order_preferences FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_preferences.order_id) AND (orders.user_id = auth.uid())))));
...
--
-- Name: order_history Users can view own order history; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own order history" ON public.order_history FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_history.order_id) AND (orders.user_id = auth.uid())))));


--
-- Name: order_preferences Users can view own order preferences; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own order preferences" ON public.order_preferences FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_preferences.order_id) AND (orders.user_id = auth.uid())))));
...
--
-- Name: washing_process allow_authenticated_washing_process; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY allow_authenticated_washing_process ON public.washing_process TO authenticated USING (true) WITH CHECK (true);
...
--
-- Name: order_history cliente_insert_own_history; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cliente_insert_own_history ON public.order_history FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_history.order_id) AND (orders.user_id = auth.uid())))));


--
-- Name: orders cliente_insert_own_orders; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cliente_insert_own_orders ON public.orders FOR INSERT TO authenticated WITH CHECK ((user_id = auth.uid()));


--
-- Name: order_preferences cliente_insert_own_preferences; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cliente_insert_own_preferences ON public.order_preferences FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.orders
  WHERE ((orders.id = order_preferences.order_id) AND (orders.user_id = auth.uid())))));


--
-- Name: orders cliente_select_own_orders; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY cliente_select_own_orders ON public.orders FOR SELECT TO authenticated USING ((user_id = auth.uid()));
...
--
-- Name: payments operador_payments; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY operador_payments ON public.payments TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text]))))));


--
-- Name: app_settings operador_settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY operador_settings ON public.app_settings TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text]))))));
...
--
-- Name: inventory operadores pueden gestionar inventario; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "operadores pueden gestionar inventario" ON public.inventory TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['operador'::text, 'admin'::text]))))));
...
--
-- Name: machines operators_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY operators_all ON public.machines USING (true);
...
--
-- Name: order_preferences; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: washing_process; Type: ROW SECURITY; Schema: public; Owner: -
--
...
\unrestrict MsnuaYRCkPgjT6Oisa1Ah2ack77WatmLjoCiZXqoMxe95PuEP0Fvua8SFqbwN5t
