...
const navItems = [
  ...
  { title: "Compras",      href: "/operador/compras",     icon: ShoppingCart },
  { title: "Clientes",     href: "/operador/clientes",    icon: UserCircle2 },
  { title: "Domiciliarios",href: "/operador/domiciliarios",icon: Bike },
